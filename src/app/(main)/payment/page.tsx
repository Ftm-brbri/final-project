...
export default function PaymentGatewayPage() {
  ...
  // TIMER EFFECT
  useEffect(() => {
    if (timeoutOpen || timeLeft <= 0) return;
        ...
        <div className="mx-auto max-w-md overflow-hidden rounded-[30px] border border-slate-200 bg-white shadow-2xl">
          ...
          <div className="bg-[#1d63d8] px-5 py-6 text-white">
            <div className="flex items-center justify-between">
              ...
              {/* TIMER */}
              <div className="rounded-xl bg-white/20 px-4 py-2 text-sm font-bold">
                {minutes}:{seconds}
              </div>
            </div>
          </div>
          ...
          <div className="p-5">
            ...
            <div className="mt-5" dir="ltr">
              ...
              <div className="grid grid-cols-3 gap-3 w-full">
                ...
                <button
                  type="button"
                  className="flex items-center justify-center w-12 rounded-2xl border border-slate-200 bg-white text-slate-600"
                >
                  <RefreshCcw size={15} />
                </button>
            ...
            <div className="mt-5">
              ...
              <div className="grid grid-cols-3 gap-10">
                <button
                  type="button"
                  className="h-15 w-35 rounded-2xl bg-[#1d63d8] px-4 py-4 font-bold text-white transition hover:opacity-90"
                >
                  دریافت رمز پویا
                </button>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 px-4">
          <div className="w-full max-w-md rounded-3xl bg-white p-8 text-center shadow-2xl">
            ...
            <p className="mt-4 leading-8 text-slate-600">
              به دلیل اتمام زمان مجاز پرداخت، تراکنش لغو شد.
            </p>
